    ...
    process {
        ...
        if (!$NoServicePrincipal) {
            ...
            if ($AdminConsent) {
                ...
                $ServicePrincipalAppRoleConsent = Invoke-RestMethod -Method Post -Uri ("https://graph.microsoft.com/beta/servicePrincipals/{0}/appRoleAssignments" -f $ServicePrincipal.Id) -Headers $MSGraphHeaders -ContentType 'application/json' -Body (ConvertTo-Json -Depth 4 @{
                    appRoleId = 'dbb9058a-0e50-45d7-ae91-66909b5d4664'
